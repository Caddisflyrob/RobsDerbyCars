...
namespace RobsDerbyCars.Controllers
{
    public class HeatController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HeatID,FirstRacer,SecondRacer,FirstRacerIsWinner,IsComplete")] Heat heat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HeatID,FirstRacer,SecondRacer,FirstRacerIsWinner,IsComplete")] Heat heat)
        {
            if (ModelState.IsValid)
            {
