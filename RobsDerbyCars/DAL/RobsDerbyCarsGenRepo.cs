...
{
    public class RobsDerbyCarsGenRepo<TEntity> : IDerbyCars<TEntity> where TEntity : class
    {
        internal DerbyContext context;
        internal DbSet<TEntity> dbSet;

        public RobsDerbyCarsGenRepo(DerbyContext dc)
        {
            context = dc;
